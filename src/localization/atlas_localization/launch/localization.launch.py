"""
atlas_localization/launch/localization.launch.py

Localization stack for Atlas.
...
Usage:
  ros2 launch atlas_localization localization.launch.py
  ros2 launch atlas_localization localization.launch.py use_amcl:=true \
...
def generate_launch_description():
    pkg = FindPackageShare('atlas_localization')
