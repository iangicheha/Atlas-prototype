"""
atlas_control/launch/control.launch.py

Starts the full ros2_control stack for Atlas:
...
Usage:
  ros2 launch atlas_control control.launch.py
  ros2 launch atlas_control control.launch.py use_sim_time:=false  # real robot
"""
...
def generate_launch_description():
    pkg = FindPackageShare("atlas_control")
