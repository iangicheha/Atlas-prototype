"""
atlas_teleop/launch/teleop.launch.py

Launches the full teleoperation stack for Atlas:
...
Usage:
  ros2 launch atlas_teleop teleop.launch.py
  ros2 launch atlas_teleop teleop.launch.py use_sim_time:=false  # real robot
"""
...
def generate_launch_description():
    pkg = FindPackageShare('atlas_teleop')
